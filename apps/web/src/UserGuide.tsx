...
export const sections: GuideSection[] = [
  ...
  { id: 'builder-photos', title: 'Desain undangan dan foto', summary: 'Atur tema, susunan, slideshow desain, dan moderasi album tamu.', roles: ['SUPERADMIN', 'EVENT_OWNER'], steps: ['Di Invitation Builder pilih tema, urutkan/tampilkan bagian, dan tinjau Mobile serta Desktop.', 'Unggah maksimal 12 gambar slideshow desain, masing-masing JPG/PNG/WebP maksimal 5 MB.', 'Pilih Save & publish design untuk menerapkan desain.', 'Tamu dapat melihat album sesuai aturan undangan, tetapi baru dapat upload setelah check-in untuk event yang sama. Ambil Foto membuka kamera browser langsung melalui HTTPS dan meminta izin kamera; Jepret, Ambil ulang, lalu Gunakan foto. Pilih dari Galeri tetap terpisah sebagai fallback jika kamera tidak didukung, tidak ditemukan, sedang dipakai, atau izinnya ditolak.', 'Di Photos, Approve menampilkan foto tamu ke album; Reject menyembunyikan; Delete menghapus permanen.'] },
